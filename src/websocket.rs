...
mod tests {
    ...
    fn test_subscription_request_new() {
        let request = SubscriptionRequest::new("123".to_string());
    ...
    fn test_subscription_request_add_stream() {
        let mut request = SubscriptionRequest::new("456".to_string());
    ...
    fn test_subscription_request_serialization() {
        let mut request = SubscriptionRequest::new("789".to_string());
        request.add_stream("btcusdt@ticker");
